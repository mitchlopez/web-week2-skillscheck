...
faveColors = ['red', 'white', 'blue']  // Also known as freedom colors//
...
me = {
    firstName: 'Mitchell',
    superHeroName: 'Mighty Mitch',
    homeTown: 'Oro Valley',
    superPowers: ['mind-reading', 'flying', 'breathing underwater'],
...
let setColor = arr => {
    ...
    for (let i = 0; i < 0; i++){
        if (arr[i] === 'blue'){
            arr[i] === '#0e00ab' //I like this shade better
        }
    }
